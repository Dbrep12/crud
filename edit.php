...
{   
    ...
    // update user data
    $result = mysqli_query($konek, "UPDATE barangg SET nama_barang='$nama_barang',harga_barang='$harga_barang',stok_barang='$stok_barang' WHERE id_barang=$id");
...
$result = mysqli_query($konek, "SELECT * FROM barangg WHERE id_barang=$id");
